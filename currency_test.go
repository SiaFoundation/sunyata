...
func TestCurrencyMul64(t *testing.T) {
	tests := []struct {
		...
		{
			BaseUnitsPerCoin.Mul64(30),
			50,
			BaseUnitsPerCoin.Mul64(1500),
		},
		{
			NewCurrency(math.MaxUint64, 0),
			2,
...
func TestCurrencyDiv(t *testing.T) {
	tests := []struct {
		...
		{
			BaseUnitsPerCoin.Mul64(156),
			NewCurrency(2, 0),
			BaseUnitsPerCoin.Mul64(78),
		},
		{
			BaseUnitsPerCoin.Mul64(300),
			BaseUnitsPerCoin.Mul64(2),
			NewCurrency(150, 0),
		},
		{
			NewCurrency(0, 1),
...
func TestParseCurrency(t *testing.T) {
	tests := []struct {
		...
		{
			"123 mC",
			BaseUnitsPerCoin.Mul64(123).Div64(1000),
			false,
		},
		{
			"2.000000001 C",
			BaseUnitsPerCoin.Mul64(2).Add(NewCurrency64(1)),
			false,
		},
		{
			"12.345 GC",
			BaseUnitsPerCoin.Mul64(12345).Mul64(1e6),
			false,
		},
		{
			"1 foo",
